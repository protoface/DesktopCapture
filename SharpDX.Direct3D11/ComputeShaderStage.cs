...
// Type: SharpDX.Direct3D11.ComputeShaderStage
...
namespace SharpDX.Direct3D11
{
	...
	{
		public ComputeShaderStage([In] IntPtr obj0)
		  : base(obj0)
		{
		}

		public static explicit operator ComputeShaderStage([In] IntPtr obj0) => !(obj0 == IntPtr.Zero) ? new ComputeShaderStage(obj0) : (ComputeShaderStage)null;
	}
}
