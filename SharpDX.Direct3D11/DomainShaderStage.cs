...
// Type: SharpDX.Direct3D11.DomainShaderStage
...
namespace SharpDX.Direct3D11
{
	...
	{
		public DomainShaderStage([In] IntPtr obj0)
		  : base(obj0)
		{
		}

		public static explicit operator DomainShaderStage([In] IntPtr obj0) => !(obj0 == IntPtr.Zero) ? new DomainShaderStage(obj0) : (DomainShaderStage)null;
	}
}
