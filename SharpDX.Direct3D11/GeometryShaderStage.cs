...
// Type: SharpDX.Direct3D11.GeometryShaderStage
...
namespace SharpDX.Direct3D11
{
	...
	{
		public GeometryShaderStage([In] IntPtr obj0)
		  : base(obj0)
		{
		}

		public static explicit operator GeometryShaderStage([In] IntPtr obj0) => !(obj0 == IntPtr.Zero) ? new GeometryShaderStage(obj0) : (GeometryShaderStage)null;
	}
}
