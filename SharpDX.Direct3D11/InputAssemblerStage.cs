...
// Type: SharpDX.Direct3D11.InputAssemblerStage
...
namespace SharpDX.Direct3D11
{
	...
	{
		public InputAssemblerStage([In] IntPtr obj0)
		  : base(obj0)
		{
		}

		public static explicit operator InputAssemblerStage([In] IntPtr obj0) => !(obj0 == IntPtr.Zero) ? new InputAssemblerStage(obj0) : (InputAssemblerStage)null;
	}
}
