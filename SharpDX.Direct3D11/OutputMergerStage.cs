...
// Type: SharpDX.Direct3D11.OutputMergerStage
...
namespace SharpDX.Direct3D11
{
	...
	{
		public OutputMergerStage([In] IntPtr obj0)
		  : base(obj0)
		{
		}

		public static explicit operator OutputMergerStage([In] IntPtr obj0) => !(obj0 == IntPtr.Zero) ? new OutputMergerStage(obj0) : (OutputMergerStage)null;
	}
}
