...
// Type: SharpDX.Direct3D11.VertexShaderStage
...
namespace SharpDX.Direct3D11
{
	...
	{
		public VertexShaderStage([In] IntPtr obj0)
		  : base(obj0)
		{
		}

		public static explicit operator VertexShaderStage([In] IntPtr obj0) => !(obj0 == IntPtr.Zero) ? new VertexShaderStage(obj0) : (VertexShaderStage)null;
	}
}
